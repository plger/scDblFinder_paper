...
`scDblFinder` first selects the most expressed features -- by default 1000, beyond which no improvement was observed (see Supplementary Figure 5A).
...
### kNN evaluation and feature matrix generation
...
## Direct classification procedure
