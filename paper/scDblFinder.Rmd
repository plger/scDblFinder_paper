...
Although the median library sizes of the doublets was generally larger than the composing cell types, they was systematically less than the sum (Figure \@ref(fig:realDbls)A).
...
and users are left to decide on a threshold. 
