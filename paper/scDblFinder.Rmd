...
This method yielded as good or better performance than specialized single-cell ATACseq software (Supplementary Figure 10).
...
We defined two forms of doublet enrichment (Figure \@ref(fig:dblenr)A-B):
