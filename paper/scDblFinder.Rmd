...
The ideal represented by the elbow of the ROC curve gives equal weight to the _rate_ of both types of errors; however, due to the lower frequency of doublets, in absolute terms this amounts to considering a missed doublet worse that a wrongly excluded singlet.
...
pdf("Figure6.pdf", width=9, height=7)
p
dev.off()
p
```
