...
**Doublets and sites covered by more than two reads (scATACseq). A:** Number of loci covered by more than two reads in annotated singlets and doublets in each dataset. **B:** Relationship between library size and the number of loci covered by more than two reads.
