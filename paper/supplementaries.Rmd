...
d <- scDblFinder(sce, sce$phenoid, returnType="table", 
                 artificialDoublets=1, score="weighted") # just for speedup
th <- doubletThresholding(d)
plotThresholds(d, dbr=dbr) + coord_cartesian(ylim=c(0,0.5))
```
